...
// =============================================
// POPUP DE CARREGAMENTO INICIAL (com barra de progresso e tempo restante)
// =============================================
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  carregarDados(veioDeSincronizacao).then(() => { restaurarEstadoLocal(); finalizarLoadingInicial(); });
});
